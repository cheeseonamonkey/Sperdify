        ...
        <div className="flex w-[95%]">
            <div className="w-full relative">
                <div className="absolute top-0 right-[-0.75em] translate-y-[.5em] bg-[rgba(1,1,1,0.1)] py-1 px-0 shadow-inner rounded inline-block scale-125 opacity-50">
                    ...
                    />
                    <label className="relative left-[-1.7em] top-[1em] text-xs pointer-events-none opacity-50 font-bold text-blue-900 z-0 font-roboto">auto</label>
                </div>
                <input
                    ref={searchRef}
                    type="text"
                    className="w-full border-2 border-gray-300 bg-white h-11 px-3 pr-4 rounded-lg text-md font-varela-round font-bold shadow-sm focus:outline-none focus:shadow-inner"
